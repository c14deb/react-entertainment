            ...
            <Container>
                <Row>
                    <Col className='col-12'>
                        <section>
                            <h1 className='txtCenter'>Top TV Series</h1>
                ...
                <Row>
                    <Col className='col-2'>
                        <LeftFilter genres={genres} selectedGenres={selectedGenres} setSelectedGenres={setSelectedGenres}  setGenres={setGenres} type="tv" setPage={setPageNo}/> 
                    </Col>
                    <Col className='col-10'>
                        <Row>
                                {
                                    content && content.length > 0 ? content.map((item, index)=>{
                                        return (<Card key={index} data={item} mediaType="tv" />)
                                    }) : 'Loading ....'
                                }
